...
//}
//
//void insertionSorf(int a[], int n) {
//	int x,j;
//	for (int i = 1; i < n; i++)
//	{
//		x = a[i];
...
//}
//
//void selectionSorf(int a[], int n) {
//	int min_Pos;
//	for (int i = 0; i < n; i++)
//	{
//		min_Pos = i;
...
//}
//
//void interchangeSorf(int a[], int n) {
//	for (int i = 0; i < n-1; i++)
//	{
//		for (int j = i+1; j < n; j++)
//		{
...
//}
//
//void quickSorf(int a[], int left, int right) {
//	int x, i, j;
//	x = a[(left + right) / 2];
//	i = left;
//	j = right;
...
//}
//
//void heapSorf(int a[],int i,int n) {
//	int j = 2 * i + 1;
//	if (j <=n)
//	{
//		return;
